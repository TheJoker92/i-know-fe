...
export declare class SensorErrorEvent extends Event {
    constructor(type: string, errorEventInitDict: SensorErrorEventInit);
    readonly error: Error;
}

export interface SensorErrorEventInit extends EventInit {
    error: Error;
}

export declare class Sensor extends EventTarget {
...
export interface MotionSensorOptions extends SensorOptions {
...
export declare class Magnetometer extends Sensor {
    constructor(options?: MotionSensorOptions);
    readonly x?: number | undefined;
    readonly y?: number | undefined;
    readonly z?: number | undefined;
...
export declare class UncalibratedMagnetometer extends Sensor {
    constructor(options?: MotionSensorOptions);
    readonly x?: number | undefined;
    readonly y?: number | undefined;
    readonly z?: number | undefined;
...
export declare class OrientationSensor extends Sensor {
...
export declare class AmbientLightSensor extends Sensor {
